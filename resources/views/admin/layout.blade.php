...
<head>
    ...
    <title>@yield('title', 'Admin') | iMugali</title>
    ...
    $adminNavGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Contact & Paramètres', 'route' => route('admin.contact.index'), 'active' => request()->routeIs('admin.contact.*'), 'icon' => 'bi-envelope'],
    ...
    <div class="admin-app">
        <aside class="admin-sidebar">
            <a href="{{ url('/admin') }}" class="admin-brand">
                <img src="{{ asset('img/logo.png') }}" alt="iMugali">
                <div class="admin-brand__copy">
                    <strong>iMugali</strong>
            ...
            <nav class="admin-topbar">
                ...
                <div class="admin-topbar__right">
                    <a href="{{ url('/') }}" class="admin-topbar__site" target="_blank" rel="noopener">
                        ...
                        <span>{{ method_exists($siteSetting, 't') ? $siteSetting->t('site_name') : ($siteSetting->site_name ?? 'iMugali') }}</span>
                    </a>
