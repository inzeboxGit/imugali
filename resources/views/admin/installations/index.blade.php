...
@section('title', 'Services Mugali')

@section('content')
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1">Services Mugali</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" class="form-control"
                        rows="3">{{ old('description', $sectionSetting->description ?? '') }}</textarea>
                </div>
                <!-- <div class="col-md-6">
                        <label class="form-label">Texte du bouton</label>
                        <input type="text" name="button_text" class="form-control"
                            value="{{ old('button_text', $sectionSetting->button_text ?? '') }}"
                            placeholder="Tous les appartements">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Lien du bouton</label>
                        <input type="text" name="button_link" class="form-control"
                            value="{{ old('button_link', $sectionSetting->button_link ?? '') }}" placeholder="/appartements">
                    </div> -->
                <div class="col-12">
                        ...
                        <tr>
                            <td>
                                @if($installation->image_path)
                                    <img src="{{ asset('storage/' . $installation->image_path) }}" alt="{{ $installation->title }}"
                            ...
                            <td class="text-end">
                                ...
                                <form action="{{ route('admin.installations.destroy', $installation) }}" method="post"
                                    class="d-inline" onsubmit="return confirm('Supprimer cette installation ?');">
                                    @csrf
                                    @method('DELETE')
