...
<head>
    ...
    <title>Site en maintenance | {{ method_exists($siteSetting, 't') ? $siteSetting->t('site_name') : ($siteSetting->site_name ?? 'iMugali') }}</title>
...
<body class="front-theme-{{ current_front_theme() }}">
    ...
    <main class="maintenance-shell">
        <div class="maintenance-card">
            <img src="{{ theme_asset('img/logo.png') }}" alt="iMugali">
