...
@section('content')
    @php
        ...
        $mainImage = media_url($aboutSectionSetting->main_image ?? null, 'themes/mugali/img/restaurant/1.jpg');
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="section-title text-dark">{{ $extraTextSectionSetting && method_exists($extraTextSectionSetting, 't') ? $extraTextSectionSetting->t('title') : ($extraTextSectionSetting->title ?? '') }}</div>
                </div>
            </div>
            @php
        ...
        <div class="container-fluid p-0">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center mb-20">
                    <div class="section-subtitle brownColor">{{ $restaurantGallerySetting->small_title }}</div>
                    <div class="section-title blackColor">{{ $restaurantGallerySetting->title }}</div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <a href="{{ media_url($imgPath) }}" title="" class="gallery-masonry-item-img-link img-zoom">
                                <div class="img"><img src="{{ media_url($imgPath) }}" class="img-fluid mx-auto d-block" alt=""></div>
                            </a>
                        </div>
                        @endforeach
                    </div>
