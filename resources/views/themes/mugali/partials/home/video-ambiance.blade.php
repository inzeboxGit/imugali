@php
    ...
    $homeVideoImageSrc = media_url($homeVideoSetting->header_image ?? null, 'themes/mugali/img/banner/01.jpg');
...
<section class="video-wrapper bg-img" data-overlay-dark="4" data-background="{{ $homeVideoImageSrc }}"
    style="background-image: url('{{ $homeVideoImageSrc }}'); height: 452px; display: flex; align-items: center;">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12 text-center rotatex">
                <a href="{{ $homeVideoPopupUrl }}" data-lity="video" class="rotate-box vid" aria-label="Lire la vidéo">
                    <div class="rotate-circle rotate-text" bis_skin_checked="1">
                ...
                @endif
                @if(!empty($homeVideoTitle))
                    <div class="section-title brownColor fwn" style="color: #fff;">{{ $homeVideoTitle }}</div>
                @endif
            </div>
        </div>
    </div>
