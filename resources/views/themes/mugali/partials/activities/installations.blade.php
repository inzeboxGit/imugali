                    ...
                    @forelse($items as $installation)
                        @php
                            ...
                            if ($hasImageIcon) {
                                ...
                                if (str_starts_with($cleanIconPath, 'themes/mugali/img/')) {
                                    $installationIconSrc = asset($cleanIconPath);
                                } elseif (str_starts_with($cleanIconPath, 'img/')) {
                                    $installationIconSrc = asset('themes/mugali/' . $cleanIconPath);
                                } else {
                                    $installationIconSrc = asset('themes/mugali/img/' . $cleanIconPath);
                                }
                            }
                        @endphp
                        <div class="col-lg-4 col-md-6 ff">
