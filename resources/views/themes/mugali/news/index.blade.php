...
@section('content')
@php
    $headerImage = media_url($newsPageSetting->header_image ?? null, 'themes/mugali/img/banner/11.jpg');
@endphp
                        ...
                        <div class="cont">
                            ...
                            <div class="author">
                                <div>
                                    ...
                                    @if($item->author ?? null)
                                        <h5>by <a href="#" class="text-decoration-line-bottom">{{ $item->author ?? 'iMugali' }}</a></h5>
                                    @endif
                                </div>
                            </div>
                        </div>
