...
<head>
    ...
    <title>{{ method_exists($siteSetting, 't') ? $siteSetting->t('site_name') : ($siteSetting->site_name ?? 'Mugali') }}</title>
    <link rel="icon" href="{{ theme_asset('img/logo.png') }}" type="image/png">
...
<body class="front-theme-{{ current_front_theme() }}">
    ...
    @include('themes.mugali.partials.layout.nav')
